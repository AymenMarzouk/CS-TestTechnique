...
urlpatterns = [
    ...
    path('utilisateur_test', views.Utilisateur_TestListView.as_view(), name="utilisateur_utilisateur"),
    path('choix_utilisateur_test', views.Choix_UtilisateurListView.as_view(), name="choix_utilisateur_test"),
]